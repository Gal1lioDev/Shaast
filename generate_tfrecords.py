...
Usage:
  ...
  # Create train data:
  python generate_tfrecords.py --csv_input=C:\Users\shukla\Desktop\Aaditya\Coding\Projects\Python\OpenCV\Computer-Vision\Datasets\Shaast\shaast_labels.csv  --output_path=train.record
